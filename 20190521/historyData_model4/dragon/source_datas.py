...
def prepareDatas(sort_history_raceCard_rows, sort_history_raceResults_rows, horse_pedigree_rows, display_sectional_time_rows, odds_sectional_rows):
    data_dict = {}
    ...
    data_dict['horse_odds_sectional_trend'] = horse_odds_sectional_trend.getOddsSectionalTrend(sort_history_raceCard_rows, sort_history_raceResults_rows, odds_sectional_rows)
