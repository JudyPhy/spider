...
def getHorseJockeyRaceCount(history_rows):
    ...
    hj_count_dict = {}  # new_race_id & {horse_code & [hj_all_count, hj_before3_count]}
    for race_id in race_id_sorted_list:
        ...
        for row in curRaceRows:
            ...
            hj = horse_code + '__' + row['jockey'].strip()
            # 赛前
    ...
    # for new_race_id, dict in hj_count_dict.items():
    #     if 'C299' in dict.keys():
    #         print(new_race_id, dict)
    # print('\n', hj_date_dict)
