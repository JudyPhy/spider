...
# win_odds: race_date_No & {horse_code & win_odds}
# plc: race_date_No & {horse_code & plc}
# going: race_date_No & {horse_code & going}
# pedigree_dst: race_date_No & {horse_code & pedigree_dst(bool)}

# horse_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_recent_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_site_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_go_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_course_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_dst_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_cls_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_draw_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
# horse_jockey_record: race_date_No & {horse_code & [No1, No2, No3, No4, All]}
...
# horse_odds_trend: race_date_No & {horse_code & odds_trend}
# horse_odds_sectional_trend: race_date_No & {horse_code & odds_sectional_trend}

# horse_rest: race_date_No & {horse_code & rest}

# horse_new_dis: race_date_No & {horse_code & new_dis}

# draw_record: race_date & {draw & [No1, No2, No3, No4, All]}
# trainer_record: race_date & {trainer & [No1, No2, No3, No4, All]}
# jockey_record: race_date & {jockey & [No1, No2, No3, No4, All]}
# jockey_recent: race_date & {jockey & [No1, No2, No3, No4, All]}
...
def prepareDatas(raceCard_rows, results_rows):
    ...
    data_dict['horse_last_dst_time_ave'], data_dict['horse_last_dst_time_prev'] = horse_last_dst_time.getHorseLastDstTimeDicts(raceCard_rows)
