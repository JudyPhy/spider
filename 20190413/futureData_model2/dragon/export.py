...
def __insert(all_list):
    ...
    sql = '''insert into {}(race_date, race_id, horse_code, horse_no, pla_odds, win_odds, plc, count, race_no, site, cls,
            ...
            new_dis, rest, act_delta, dct_delta, hj_raceCount, hj_raceCount_before3, ht_raceCount, ht_raceCount_before3,
            jt_raceCount, jt_raceCount_before3)
...
def __createNewTable():
    ...
    ht_raceCount_before3 INT DEFAULT 0,
    jt_raceCount INT DEFAULT 0,
    jt_raceCount_before3 INT DEFAULT 0)'''.format(RESULT_TABLE)
