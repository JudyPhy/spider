...
def prepareDatas(sort_history_raceCard_rows, sort_history_raceResults_rows, horse_pedigree_rows,
                 course_standard_times_rows, odds_sectional_rows):
    data_dict = {}
    ...
    data_dict['horse_odds_wave'] = horse_odds_wave.getOddsWave(sort_history_raceCard_rows, sort_history_raceResults_rows, odds_sectional_rows)
