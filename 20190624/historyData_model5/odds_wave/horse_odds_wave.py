...
def getOddsWave(sort_history_raceCard_rows, sort_history_raceResults_rows, odds_sectional_rows):
                ...
                if cur_plc not in common.words:
                    ...
                    if (race_date_No in odds_sectional_rows.keys()) and (horse_No in odds_sectional_rows[race_date_No].keys()):
                        ...
                        if odds3 == '' or odds4 == '':
                            ...
                            odds_wave_dict[race_date_No][horse_code] = (float(odds4) - float(odds3))/float(odds3)
