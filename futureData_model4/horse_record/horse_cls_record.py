...
def __getClsDict(race_No_dict):
    ...
    if singleton_Scrub_DB.table_exists(HORSE_RACE_TABLE):
        singleton_Scrub_DB.cursor.execute('select race_date,class,race_id from {}'.format(HORSE_RACE_TABLE))
...
def getHorseClsRecord(raceCard_rows, results_rows, plc_dict):
    ...
    cls_record_dict = {}  # race_date_No & {horse_code & [No1, No2, No3, No4, Fail]}
    temp_plc_record = {}  # horse_code & {cls & [No1, No2, No3, No4, Fail]}
