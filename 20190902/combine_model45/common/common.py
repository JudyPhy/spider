...
ODDS_IMMD_TABLE = 'dd_odds_immd'

ODDS_MODEL45_TABLE = 'table_dragon_history_model6'

HISTORY_MODEL4_TABLE = 'table_dragon_history_model4'

HISTORY_MODEL5_TABLE = 'table_dragon_history_model5'

ODDS_IMMD_SECTIONAL_TABLE = 'dd_odds_sectional'
