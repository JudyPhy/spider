from update_model4 import update_race_info as update_data_model4
...
def main():
    ...
    today_race_start_time = request_db_data.RequestTodayRaceStartTime(race_date)   # race_No & [start_time, before10_time, before20_time]
    while(True):
        ...
        for update_table, dict in today_table_rows.items():
            if 'model4' in update_table:
                update_data_model4.updateModel4(update_table, dict, immd_rows, lastest_rows, race_results_rows,
                                           race_card_history_rows, display_sectional_time_rows, today_race_start_time)
