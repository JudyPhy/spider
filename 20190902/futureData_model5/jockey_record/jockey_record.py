...
def __getJockeyRecords(jockey, history_raceResults_rows):
...
def GetJockeyRecord(future_raceCard_rows, immd_info_dict, history_raceResults_rows):
    jockey_record_dict = {}  # jockey & [No1, No2, No3, No4, All]
    jockey_list = []
    ...
    for jockey in jockey_list:
        jockey_record_dict[jockey] = __getJockeyRecords(jockey, history_raceResults_rows)
